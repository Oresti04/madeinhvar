    ...
    <section>
      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-3">
          <img src="/images/insta-1.svg" alt="Insta" className="w-full h-32 object-cover rounded" />
          <img src="/images/insta-2.svg" alt="Insta" className="w-full h-32 object-cover rounded" />
          <img src="/images/insta-3.svg" alt="Insta" className="w-full h-32 object-cover rounded" />
        </div>
      </section>
    </section>
  )
